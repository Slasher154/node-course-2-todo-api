...
// allow us to run some code before test cases
beforeEach((done) => {
  // Remove all todos
  Todo.remove({}).then(() => {
...
describe('GET /todos/:id', () => {
  it('should return todo doc', (done) => {
    request(app)
      .get(`/todos/${todos[0]._id.toHexString()}`) // Convert ObjectID to string with Hexstring because it is passed at URL (not part of Mongo query)
      .expect(200)
      .expect((res) => {
